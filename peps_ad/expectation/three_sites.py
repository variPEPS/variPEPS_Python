...
def calc_three_sites_triangle_without_top_left_single_gate(
    ...
    :obj:`~peps_ad.expectation.three_sites.calc_three_sites_triangle_without_top_left_multiple_gates`.
...
def calc_three_sites_triangle_without_top_right_single_gate(
    ...
    This function just wraps
    :obj:`~peps_ad.expectation.three_sites.calc_three_sites_triangle_without_top_right_multiple_gates`.
...
def calc_three_sites_triangle_without_bottom_left_single_gate(
    ...
    This function just wraps
    :obj:`~peps_ad.expectation.three_sites.calc_three_sites_triangle_without_bottom_left_multiple_gates`.
...
def calc_three_sites_triangle_without_bottom_right_single_gate(
    ...
    This function just wraps
    :obj:`~peps_ad.expectation.three_sites.calc_three_sites_triangle_without_bottom_right_multiple_gates`.
